        ...
        <div className="relative flex flex-col items-center gap-16 md:gap-24">
          ...
          <div className="flex max-w-5xl flex-col items-center justify-center space-y-8 text-center">
            <div className="space-y-6">
              ...
              >
                A community driven component library built with React and
                Tailwind. Designed with minimal dependencies for developers who
                value simplicity, speed, and flexibility.
              </motion.p>
