    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-lg text-gray-400 leading-relaxed">
          Discover elegant, responsive, and highly
          customizable UI components that seamlessly integrate into your
          projects. Each component is crafted with as few dependencies as possible,
          so you can copy + paste your way to beautiful interfaces faster.
        </p>
      </div>
        ...
        {sectionCards.map((card) => (
          ...
          >
            <div className="group bg-gray-800/80 backdrop-blur-lg rounded-xl overflow-hidden border border-gray-700/50 hover:border-sectifyGreen/50 shadow-lg hover:shadow-sectifyGreen/20 transition-all duration-300">
              ...
              <div className="p-5">
                <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-sectifyGreen transition-colors">{card.title}</h3>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 text-sm font-medium group-hover:text-sectifyGreen/80 transition-colors">{card.description}</span>
