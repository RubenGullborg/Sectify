...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 flex flex-col bg-black text-gray-200 shadow-xl shadow-blue-gray-900/5 border-sectifyLightPurple border-r-4 pt-20 overflow-y-auto">
      <nav className="flex flex-col gap-1 px-2 font-sans text-base font-normal text-gray-200">
        <h3 className="text-lg font-semibold px-3 py-2 text-sectifyGreen border-b border-sectifyLightPurple">Component Library</h3>
        
        {/* Sections Category */}
        <div className="relative block w-full mt-2">
          <div className="flex items-center w-full leading-tight rounded-lg outline-none bg-gray-700/50 text-start text-gray-200 hover:bg-gray-700 hover:bg-opacity-80 hover:text-sectifyGreen">
            <button
              type="button"
            ...
            >
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 mr-3 text-sectifyGreen">
            ...
            <nav className="flex flex-col gap-1 p-1 font-sans text-sm font-normal text-gray-300">
              ...
              >
                <div className="grid mr-3 place-items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="3" stroke="currentColor" className="w-4 h-3">
